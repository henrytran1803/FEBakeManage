...
export default function HomePage() {
  ...
  // Thêm phần tính totalItems
  const totalItems =
    currentCart?.carts.reduce((sum, item) => sum + item.quantity, 0) || 0;
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="w-full px-2 py-2">
        ...
        <div className="mb-3">
         ...
         {/* Giỏ hàng - Đặt ở giữa hoặc bên phải */}
    <div className="flex justify-end mb-3"> {/* hoặc justify-center nếu muốn ở giữa */}
        <div className="relative">
            <button 
                onClick={() => navigate('/cart')}
                className="p-2.5 bg-white shadow rounded-lg flex items-center justify-center gap-2"
            >
